...
t6 = Article.create!(user_id: user.id, article_type: "top", title: "top6", formality: 2, rain: true, clouds: true, snow: false, wind: true)
t7 = Article.create!(user_id: user.id, article_type: "top", title: "top7", formality: 4, rain: true, clouds: true, snow: false, wind: true)
t8 = Article.create!(user_id: user.id, article_type: "top", title: "top8", formality: 5, rain: true, clouds: true, snow: false, wind: true)
#BOTTOMS
...
b5 = Article.create!(user_id: user.id, article_type: "bottom", title: "bottom5", formality: 3, rain: false, clouds: true, snow: false, wind: false)
b6 = Article.create!(user_id: user.id, article_type: "bottom", title: "bottom6", formality: 5, rain: false, clouds: true, snow: false, wind: false)
#OUTERWEAR
...
o4 = Article.create!(user_id: user.id, article_type: "outerwear", title: "outerwear4", formality: 3, rain: true, clouds: true, snow: false, wind: true)
#DRESSES
...
d3 = Article.create!(user_id: user.id, article_type: "dress", title: "dress3", formality: 4, rain: false, clouds: true, snow: false, wind: false)
#SHOES
...
s3 = Article.create!(user_id: user.id, article_type: "shoes", title: "shoes3", formality: 5, rain: false, clouds: true, snow: false, wind: true)
