...
#TOPS
t1 = Article.create!(user_id: user.id, article_type: "top", title: "Atmosphere concert T-shirt", color: 'black', formality: 1, rain: true, clouds: true, snow: false, wind: true, last_worn: Date.today)
